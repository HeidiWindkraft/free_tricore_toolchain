 ...
 * (L)
*/
#ifndef OTCTLASML_MNEMS_HXX
#define OTCTLASML_MNEMS_HXX 1
...
extern mnems_e mnemsFromString(StringView s);
extern StringView mnemsToString(uintn_t val);
inline StringView toString(mnems_e val) { return mnemsToString((uint16_t) val); }
